...
const models: TsoaRoute.Models = {
  ...
  IProfileListDto: {
    ...
    properties: {
      ...
      data: {
        dataType: "array",
        array: { dataType: "refObject", ref: "IProfileDto" },
        required: true,
      },
    },
    additionalProperties: false,
  ...
  IWgServerDto: {
    ...
    properties: {
      ...
      createdAt: {
        ...
        subSchemas: [
          { dataType: "datetime" },
          {
            dataType: "nestedObjectLiteral",
            nestedProperties: {
              undefined: { dataType: "enum", enums: [true] },
            },
          },
        ],
      },
      ...
      clients: {
        dataType: "array",
        array: { dataType: "refObject", ref: "IWgClientsDto" },
      },
  ...
  IWgServersListDto: {
    ...
    properties: {
      ...
      data: {
        dataType: "array",
        array: { dataType: "refObject", ref: "IWgServerDto" },
        required: true,
      },
    },
    additionalProperties: false,
...
export function RegisterRoutes(router: KoaRouter) {
    ...
    async function ProfileController_getMyProfile(context: any, next: any) {
      ...
      const container: IocContainer =
        typeof iocContainer === "function"
          ? (iocContainer as IocContainerFactory)(context.request)
          : iocContainer;

      const controller: any = await container.get<ProfileController>(
        ProfileController,
      );
  ...
  router.patch(
    ...
    async function ProfileController_updateMyProfile(context: any, next: any) {
      ...
      const promise = controller.updateMyProfile.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
  ...
  router.delete(
    ...
    ...fetchMiddlewares<Middleware>(ProfileController),
    ...fetchMiddlewares<Middleware>(
      ProfileController.prototype.deleteMyProfile,
    ),
    ...
    async function ProfileController_deleteMyProfile(context: any, next: any) {
      ...
      const promise = controller.deleteMyProfile.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
  ...
  router.get(
    ...
    async function ProfileController_getAllProfiles(context: any, next: any) {
      ...
      const promise = controller.getAllProfiles.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
  ...
  router.get(
    ...
    async function ProfileController_getProfileById(context: any, next: any) {
      ...
      const promise = controller.getProfileById.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
  ...
  router.patch(
    ...
    async function ProfileController_updateProfile(context: any, next: any) {
      ...
      const promise = controller.updateProfile.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
  ...
  router.delete(
    ...
    async function ProfileController_deleteProfile(context: any, next: any) {
      ...
      const promise = controller.deleteProfile.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
  ...
  router.post(
    ...
    async function AuthController_signUp(context: any, next: any) {
      ...
      const controller: any = await container.get<AuthController>(
        AuthController,
      );
      if (typeof controller["setStatus"] === "function") {
        controller.setStatus(undefined);
  ...
  router.get(
    ...
    async function WireguardController_startVpn(context: any, next: any) {
      ...
      const controller: any = await container.get<WireguardController>(
        WireguardController,
      );
      if (typeof controller["setStatus"] === "function") {
        controller.setStatus(undefined);
      ...
      const promise = controller.startVpn.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
  ...
  router.get(
    ...
    async function WireguardController_stopVpn(context: any, next: any) {
      ...
      const promise = controller.stopVpn.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
  ...
  router.get(
    ...
    async function WireguardController_checkStatus(context: any, next: any) {
      ...
      const promise = controller.checkStatus.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
  ...
  router.get(
    ...
    async function WgServerController_startServer(context: any, next: any) {
      ...
      const controller: any = await container.get<WgServerController>(
        WgServerController,
      );
      if (typeof controller["setStatus"] === "function") {
        controller.setStatus(undefined);
      ...
      const promise = controller.startServer.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
  ...
  router.get(
    ...
    async function WgServerController_stopServer(context: any, next: any) {
      ...
      const promise = controller.stopServer.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
  ...
  router.get(
    ...
    ...fetchMiddlewares<Middleware>(WgServerController),
    ...fetchMiddlewares<Middleware>(
      WgServerController.prototype.getServerStatus,
    ),
    ...
    async function WgServerController_getServerStatus(context: any, next: any) {
      ...
      const promise = controller.getServerStatus.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
  ...
  router.get(
    ...
    async function WgServerController_getWgServers(context: any, next: any) {
      ...
      const promise = controller.getWgServers.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
  ...
  router.get(
    ...
    async function WgServerController_getWgServer(context: any, next: any) {
      ...
      const promise = controller.getWgServer.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
  ...
  router.post(
    ...
    ...fetchMiddlewares<Middleware>(WgServerController),
    ...fetchMiddlewares<Middleware>(
      WgServerController.prototype.createWgServer,
    ),
    ...
    async function WgServerController_createWgServer(context: any, next: any) {
      ...
      const promise = controller.createWgServer.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
  ...
  router.delete(
    ...
    ...fetchMiddlewares<Middleware>(WgServerController),
    ...fetchMiddlewares<Middleware>(
      WgServerController.prototype.deleteWgServer,
    ),
    ...
    async function WgServerController_deleteWgServer(context: any, next: any) {
      ...
      const promise = controller.deleteWgServer.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
  ...
  router.get(
    ...
    async function WgClientController_getWgClients(context: any, next: any) {
      ...
      const controller: any = await container.get<WgClientController>(
        WgClientController,
      );
      if (typeof controller["setStatus"] === "function") {
        controller.setStatus(undefined);
      ...
      const promise = controller.getWgClients.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
  ...
  router.get(
    ...
    async function WgClientController_getWgClient(context: any, next: any) {
      ...
      const promise = controller.getWgClient.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
  ...
  router.get(
    ...
    ...fetchMiddlewares<Middleware>(WgClientController),
    ...fetchMiddlewares<Middleware>(
      WgClientController.prototype.getWgClientConfiguration,
    ),

    async function WgClientController_getWgClientConfiguration(
      context: any,
      next: any,
    ) {
      const args = {
      ...
      const promise = controller.getWgClientConfiguration.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
  ...
  router.post(
    ...
    ...fetchMiddlewares<Middleware>(WgClientController),
    ...fetchMiddlewares<Middleware>(
      WgClientController.prototype.createWgClient,
    ),
    ...
    async function WgClientController_createWgClient(context: any, next: any) {
      ...
      const promise = controller.createWgClient.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
  ...
  router.patch(
    ...
    ...fetchMiddlewares<Middleware>(WgClientController),
    ...fetchMiddlewares<Middleware>(
      WgClientController.prototype.updateWgClient,
    ),
    ...
    async function WgClientController_updateWgClient(context: any, next: any) {
      ...
      const promise = controller.updateWgClient.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
  ...
  router.delete(
    ...
    ...fetchMiddlewares<Middleware>(WgClientController),
    ...fetchMiddlewares<Middleware>(
      WgClientController.prototype.deleteWgClient,
    ),
    ...
    async function WgClientController_deleteWgClient(context: any, next: any) {
      ...
      const promise = controller.deleteWgClient.apply(
        controller,
        validatedArgs as any,
      );
      return promiseHandler(controller, promise, context, undefined, undefined);
        ...
        if (Object.keys(secMethod).length > 1) {
          ...
          for (const name in secMethod) {
            secMethodAndPromises.push(
              koaAuthentication(context.request, name, secMethod[name]).catch(
                pushAndRethrow,
              ),
            );
          }
